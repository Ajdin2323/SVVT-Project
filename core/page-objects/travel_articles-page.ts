...
export class TravelArticles extends BasePage {
    ...
    private travelArticle = By.xpath("//a[@href='https://www.booking.com/articles.html?aid=304142&label=gen173nr-1FCAEoggI46AdIM1gEaBKIAQGYATG4ARfIAQzYAQHoAQH4AQKIAgGoAgO4ApDf66wGwAIB0gIkNzZkMWVjNzctZThhMi00M2U1LWE0OTAtOGFjM2JlNDE5YmRh2AIF4AIB&sid=9c222f19c18740e88c7b7059606be4c3']//div[@class='aca0ade214 ebac6e22e9 c2931f4182 e7d9f93f4d d79e71457a']");
    ...
    async ClickthreeLines(){
        await this.findElementAndClick(this.threeLines);                      /*Notice the "bug" here. When the window is maximized three lines doesnt exist
                                                                              But when its minimized it is there. My guess is that this is why my test is failing*/     
    }

    async ClicktravelArticle(){
        await this.findElementAndClick(this.travelArticle);
    }
